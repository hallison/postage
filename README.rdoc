...
* For Markdown filter:
  * {Maruku}[http://maruku.rubyforge.org/] which is default library.
...
Postage is Copyright (c) 2009 Hallison Batista and distributed under the MIT
license. See the COPYING file for more info.
